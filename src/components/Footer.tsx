      ...
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="text-center mb-8">
          <h3 className="text-2xl font-bold text-white mb-2">
            Indonesia International Smart City Expo & Forum (IISCEF)
          </h3>
          <div className="flex items-center justify-center text-white/90 text-sm mb-2">
            ...
            August 13-16, 2025 | JIExpo Kemayoran, Jakarta
          </div>
          <div className="text-white/70 text-xs">Frame 26</div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div>
            ...
            <div className="space-y-3 text-white/90 text-sm">
              <div className="font-medium">PT Napindo Media Ashatama</div>
              ...
              <div className="flex items-start">
                ...
                <span>
                  Jl. Kelapa Puan Raya Blok 8A 2 No. 1, 2, Kelapa Gading,
                  Jakarta 14240
                </span>
              </div>
          ...
          <div>
            ...
            <div className="space-y-3 text-white/90 text-sm">
              <div className="text-white/70 text-xs mb-4">Layer_1</div>
